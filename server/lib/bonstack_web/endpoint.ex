defmodule BonstackWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :bonstack

  socket "/socket", BonstackWeb.UserSocket
  ...
  plug Plug.Session,
    store: :cookie,
    key: "_bonstack_key",
    signing_salt: "80kCfCS0"

  plug BonstackWeb.Router
