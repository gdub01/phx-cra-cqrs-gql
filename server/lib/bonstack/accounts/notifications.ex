defmodule Bonstack.Accounts.Notifications do
  ...
  defp publish(%User{uuid: uuid, version: version} = user) do
    Registry.dispatch(Bonstack.Accounts, {User, uuid, version}, fn entries ->
  ...
  defp subscribe_and_wait(schema, uuid, version) do
    Registry.register(Bonstack.Accounts, {schema, uuid, version}, [])
