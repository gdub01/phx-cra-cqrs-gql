defmodule Bonstack.Accounts.Commands.UpdateUser do
  defstruct [
    user_uuid: "",
    username: "",
    email: "",
  ...
  alias Bonstack.Accounts.Commands.UpdateUser
...
defimpl Bonstack.Validation.Middleware.Uniqueness.UniqueFields, for: Bonstack.Accounts.Commands.UpdateUser do
  def unique(%Bonstack.Accounts.Commands.UpdateUser{user_uuid: user_uuid}), do: [
